          ...
          >
            ...
            <p style={{ color: isDarkMode ? "#bbb" : "#6c757d" }}>
              {searchQuery
                ...
                : "Check back later for lost items"}
            </p>
          </div>
        ) : (
          <>
                ...
                <Col key={item._id} md={6} lg={4}>
                  ...
                  >
                    ...
                    <Card.Body className="d-flex flex-column">
                      <Card.Title
                        className="mb-3"
                        style={{ color: isDarkMode ? "#f0f0f0" : "#212529" }}
                      >
                        {item.name}
                      </Card.Title>
                      ...
                      <div className="mt-auto">
                        <div className="d-flex align-items-center mb-2">
                          <FaMapMarkerAlt
                            ...
                            size={14}
                            style={{
                              color: isDarkMode ? "#4ca1af" : "#667eea",
                            }}
                          />
                          <small
                        ...
                        <div className="d-flex align-items-center mb-2">
                          ...
                          >
                            {item.dateLost
                              ? moment(item.dateLost).format("MMM D, YYYY")
                              : "Date not specified"}
                          </small>
                        </div>
                        <div className="d-flex align-items-center mb-2">
                      ...
                      <Button
                        ...
                        variant={
                          isDarkMode ? "outline-light" : "outline-primary"
                        }
